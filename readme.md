...
> ⚠️ **DEPRECATED:** To ensure compatibility with the old `$event` and `$el` parameters, it still possible to use them. For this, consult the [old documentation](https://github.com/wide/modulus/tree/2.1.2#parameters).
